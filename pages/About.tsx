      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 md:mb-24 text-center animate-fade-in-up">
           <div className="inline-flex items-center px-4 py-1.5 mb-8 border border-white/10 rounded-full bg-white/5 backdrop-blur-md">
            ...
            <span className="text-xs font-bold tracking-[0.2em] text-white uppercase">B2B Professional & B2C</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-bold text-white leading-none mb-8 tracking-tighter">
            BE SPECIAL,<br />
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed font-light">
            ...
            프리미엄 유통 서비스를 결합하여<br className="hidden md:block"/> 새로운 비즈니스 가치를 창출합니다.
          </p>
        </div>

        {/* Sub Navigation */}
        <div className="flex justify-center mb-16">
          <div className="flex space-x-8 md:space-x-12 border-b border-white/10 overflow-x-auto no-scrollbar">
            {['greeting', 'vision', 'philosophy'].map((t) => (
              <button 
                key={t}
                onClick={() => setActiveTab(t)}
                className={`pb-4 text-sm md:text-base font-bold tracking-widest uppercase transition-all relative whitespace-nowrap ${
            ...
            <div className="max-w-4xl mx-auto bg-neutral-900/40 backdrop-blur-sm border border-white/5 p-8 md:p-16 rounded-sm">
              <div className="flex flex-col md:flex-row gap-12 items-start">
                <div className="flex-1 space-y-6">
                  <h3 className="text-2xl font-bold text-white mb-8">CEO Message</h3>
                  <div className="space-y-8 text-gray-300 leading-8 font-light text-justify">
                    <p>
                    ...
                    <p>
                      <span className="text-xl text-white font-serif block my-4 border-l-2 border-white/30 pl-6 py-2 italic">
                  ...
                  <div className="mt-16 pt-10 border-t border-white/10 flex justify-between items-end">
                     <div>
                       <p className="text-xs text-gray-500 uppercase tracking-widest mb-2">Signature</p>
                       <p className="text-white text-2xl font-serif italic opacity-80">Kim Jeong Woo</p>
                     </div>
                     <div className="text-right">
                       <p className="text-sm text-gray-400 mb-1">대표이사</p>
                       <p className="text-white font-bold text-xl tracking-wide">김 정 우</p>
                     </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={idx} className={`${item.bg} border border-white/5 p-10 flex flex-col justify-between h-80 group hover:border-white/20 transition-all duration-500`}>
                    <div>
                      <h3 className="text-4xl font-light text-white/20 mb-2 group-hover:text-white transition-colors duration-300">{item.en}</h3>
                      <h4 className="text-2xl font-bold text-white mb-4">{item.ko}</h4>
                      <div className="w-8 h-0.5 bg-white/20 group-hover:w-full transition-all duration-500 mb-6"></div>
          ...
          {activeTab === 'philosophy' && (
            <div className="max-w-5xl mx-auto">
               <div className="text-center mb-16">
                 ...
                 <p className="text-gray-400">책임있는 경영과 굳건한 신뢰로 더 나은 미래를 만듭니다.</p>
               </div>

               <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                 {/* Responsibility */}
                 <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-b from-blue-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                    <div className="bg-neutral-900/50 border border-white/5 p-10 rounded-2xl h-full relative z-10 hover:border-white/20 transition-all">
                       <div className="text-5xl font-bold text-white/10 mb-6">01</div>
                       <h3 className="text-2xl font-bold text-white mb-2">책임 경영</h3>
                       <h4 className="text-sm font-bold text-blue-400 uppercase tracking-widest mb-6">Responsibility</h4>
                 ...
                 {/* Trust */}
                 <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-b from-purple-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                    <div className="bg-neutral-900/50 border border-white/5 p-10 rounded-2xl h-full relative z-10 hover:border-white/20 transition-all">
                       <div className="text-5xl font-bold text-white/10 mb-6">02</div>
                       <h3 className="text-2xl font-bold text-white mb-2">신뢰 경영</h3>
                       <h4 className="text-sm font-bold text-purple-400 uppercase tracking-widest mb-6">Trust</h4>
                       <p className="text-gray-400 leading-8">
