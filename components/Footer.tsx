        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
               {/* Social placeholders or simple links */}
               <div className="w-10 h-10 border border-white/10 flex items-center justify-center text-gray-500 hover:text-white hover:border-white transition-colors cursor-pointer">In</div>
               <div className="w-10 h-10 border border-white/10 flex items-center justify-center text-gray-500 hover:text-white hover:border-white transition-colors cursor-pointer">Fb</div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-white font-bold mb-6 uppercase tracking-wider text-sm">Business</h3>
            <ul className="space-y-4 text-gray-500 text-sm">
